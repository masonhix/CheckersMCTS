...
public class PlayerHelperStupid {
    ...
    public static void main(String argv[]) throws Exception {
        ...
        //PlayerHelperStupid stupid = new PlayerHelperStupid();
        play(argv);
    }
    ...
    public static void play(String argv[]) throws Exception {
        ...
        if (player1 == 1) {
            ...
            PlayerStupid.FindBestMove(1,board,bestmove);
            ...
            PlayerStupid.FindBestMove(2,board,bestmove);
            if (bestmove[0] != 0) { /* There is a legal move */
                mlen = MoveLength(bestmove);
                PerformMove(board, bestmove, mlen);
                buf = MoveToText(bestmove);
